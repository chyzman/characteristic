    ...
    public static void initClient() {
        ClientConfigurationNetworking.registerGlobalReceiver(
            ...
            (payload, context) -> context
                .client()
                .setScreen(new BraidScreen(
                    new BraidScreen.Settings().
                    new CharacterPicker(payload.choices, character -> context.responseSender().sendPacket(new PickCharacter(character.id())))
                ))
        );
    }
